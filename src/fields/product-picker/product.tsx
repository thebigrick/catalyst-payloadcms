...
const Product: React.FC<Props> = memo(
  ({ entityId, onClear, readOnly }) => {
    ...
    return (
      <div className="product-preview">
        ...
        {!readOnly && (
          <div>
            <button className="product-action btn" onClick={handleClear}>
  ...
  (prevProps, nextProps) => prevProps.entityId === nextProps.entityId,
);
